...
module.exports = exports = function muri(str) {
    ...
    uris.split(',').forEach(function (uri) {
        ...
        if (o.host) {
            ret.hosts.push({
                host: o.host, port: parseInt(o.port, 10)
            })
        ...
        if (o.auth) {
            ret.auth = {
                user: o.auth.user, pass: o.auth.pass
            }
        }
    })
...
function parse(uriString) {
    // do not use require('url').parse b/c it can't handle # in email or pwd
