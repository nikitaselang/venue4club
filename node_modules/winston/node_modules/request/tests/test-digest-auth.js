...
var digestServer = http.createServer(function (req, res) {
    ...
    if (req.headers.authorization) {
        if (req.headers.authorization == 'Digest email="test", realm="Private", nonce="WpcHS2/TBAA=dffcc0dbd5f96d49a5477166649b7c0ae3866a93", uri="/test/", qop="auth", response="54753ce37c10cb20b09b769f0bed730e", nc="1", cnonce=""') {
            ok = true;
        } else {
